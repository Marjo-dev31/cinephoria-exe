...
import { LoginCredantialInterface, CurrentUserInterface } from '../../login/models/user.interface';
...
export class UserService {
  ...
  login(credentials: LoginCredantialInterface): Observable<CurrentUserInterface> {
    return this.http.post<CurrentUserInterface>(`${this.url}/login`, credentials).pipe(
      tap((user) => {
